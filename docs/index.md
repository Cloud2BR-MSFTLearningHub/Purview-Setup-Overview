...
<div class="guide-grid">
  <a class="guide-card" href="overview/"><strong>Overview</strong><br>Understand Purview's governance and compliance boundaries.</a>
  <a class="guide-card" href="foundation/governance-and-roles/"><strong>Foundation</strong><br>Define ownership, roles, and access before scanning data.</a>
  <a class="guide-card" href="operations/deployment-checklist/"><strong>Deployment</strong><br>Use evidence-backed rollout controls.</a>
</div>
