...
- [Microsoft Purview for AI (artificial intelligence)](https://learn.microsoft.com/en-us/purview/ai-microsoft-purview)
...
service (SaaS), on-premises, and AI (artificial intelligence) environments.
...
adopt AI (artificial intelligence). DSPM (Data Security Posture Management) consolidates insights from information protection, DLP (data loss prevention), insider
...
DSPM (Data Security Posture Management) presents objectives such as preventing oversharing, preventing exfiltration
to risky destinations, discovering sensitive data, and protecting data in AI (artificial intelligence)
...
3. Review the posture dashboard, objectives, and AI (artificial intelligence) observability.
4. Apply recommended actions, such as labels and DLP (data loss prevention) policies, deliberately.
5. Keep human review and audit over any automated or AI (artificial intelligence)-driven remediation.

## Verify and operate

- Confirm the connected solutions (information protection, DLP (data loss prevention), insider risk) are
...
- Validate that any automated or AI (artificial intelligence)-driven action is logged, reversible, and within
  an approved scope.
...
> sensitive data, applies the recommended sensitivity label and DLP (data loss prevention) policy in a
